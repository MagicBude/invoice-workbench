          ...
          <table className="w-full min-w-[1400px] border-collapse text-sm">
            <thead className="sticky top-0 z-10 bg-slate-100 text-slate-600">
              <tr>
                ...
                <th className="min-w-60 px-3 py-3 text-left font-semibold">PDF文件名</th>
                ...
                <th className="w-16 px-3 py-3 text-center font-semibold">删除</th>
              </tr>
            </thead>
            <tbody>
              {records.map((record, index) => (
                <tr key={record.id} className="border-t border-slate-100 align-top hover:bg-slate-50/80">
                  ...
                  <td className="px-3 py-2 text-slate-700">{record.sourceFileName}</td>
                  {editableColumns.map((column) => (
